...
export interface ApiHomeBannerHomeBanner extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    trustBadgeSubtitle: Schema.Attribute.String;
    trustBadgeTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomeFaqHomeFaq extends Struct.SingleTypeSchema {
  collectionName: 'home_faq';
  info: {
    displayName: 'Home FAQ';
    pluralName: 'home-faq-list';
...
export interface ApiHomeLogoSliderHomeLogoSlider
  extends Struct.SingleTypeSchema {
  collectionName: 'home_logo_slider';
  info: {
    displayName: 'Home Logo Slider';
    pluralName: 'home-logo-slider-list';
    singularName: 'home-logo-slider';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiHomePortfolioHomePortfolio extends Struct.SingleTypeSchema {
  collectionName: 'home_portfolio';
  info: {
    displayName: 'Home Portfolio';
    pluralName: 'home-portfolio-list';
...
export interface ApiHomeServicesHomeServices extends Struct.SingleTypeSchema {
  collectionName: 'home_services';
  info: {
    displayName: 'Home Services';
    pluralName: 'home-services-list';
    singularName: 'home-services';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-services.home-services'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tagline: Schema.Attribute.String;
...
export interface ApiHomeSkillsHomeSkills extends Struct.SingleTypeSchema {
  collectionName: 'home_skills';
  info: {
    displayName: 'Home Skills';
    pluralName: 'home-skills-list';
    singularName: 'home-skills';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiHomeStatsHomeStats extends Struct.SingleTypeSchema {
  collectionName: 'home_stats';
  info: {
    displayName: 'Home Stats';
    pluralName: 'home-stats-list';
    singularName: 'home-stats';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiHomeTeamHomeTeam extends Struct.SingleTypeSchema {
  collectionName: 'home_team';
  info: {
    displayName: 'Home Team';
    pluralName: 'home-team-list';
...
export interface ApiHomeTestimonialsHomeTestimonials
  extends Struct.SingleTypeSchema {
  collectionName: 'home_testimonials';
  info: {
    displayName: 'Home Testimonials';
    pluralName: 'home-testimonials-list';
    singularName: 'home-testimonials';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-testimonials.home-testimonials'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tagline: Schema.Attribute.String;
...
export interface ApiHomeWhyChooseUsHomeWhyChooseUs
  extends Struct.SingleTypeSchema {
  collectionName: 'home_why_choose_us';
  info: {
    displayName: 'Home Why Choose Us';
    pluralName: 'home-why-choose-us-list';
    singularName: 'home-why-choose-us';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-why-choose-us.home-why-choose-us'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tagline: Schema.Attribute.String;
...
export interface ApiHomeWorkingProcessHomeWorkingProcess
  extends Struct.SingleTypeSchema {
  collectionName: 'home_working_process';
  info: {
    displayName: 'Home Working Process';
    pluralName: 'home-working-process-list';
    singularName: 'home-working-process';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-working-process.home-working-process'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPortfolioPagePortfolioPage extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'portfolio-page-list';
...
export interface ApiServiceContentCategoryServiceContentCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_content_categories';
  info: {
    description: 'SEO content categories (e.g. Home Construction, Interior Design) shown in the Services mega-menu and at /:categorySlug';
    displayName: 'Service Content Category';
    pluralName: 'service-content-categories';
    singularName: 'service-content-category';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    contentPages: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-content-page.service-content-page'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServiceContentPageServiceContentPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'service_content_pages';
  info: {
    description: 'Individual SEO content/knowledge-base pages at /:categorySlug/:contentSlug';
    displayName: 'Service Content Page';
    pluralName: 'service-content-pages';
    singularName: 'service-content-page';
  };
  options: {
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-logo-slider.home-logo-slider': ApiHomeLogoSliderHomeLogoSlider;
      'api::home-portfolio.home-portfolio': ApiHomePortfolioHomePortfolio;
      'api::home-services.home-services': ApiHomeServicesHomeServices;
      'api::home-skills.home-skills': ApiHomeSkillsHomeSkills;
      'api::home-stats.home-stats': ApiHomeStatsHomeStats;
      'api::home-team.home-team': ApiHomeTeamHomeTeam;
      'api::home-testimonials.home-testimonials': ApiHomeTestimonialsHomeTestimonials;
      'api::home-why-choose-us.home-why-choose-us': ApiHomeWhyChooseUsHomeWhyChooseUs;
